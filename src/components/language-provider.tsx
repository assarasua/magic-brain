...
const spanish: Record<string, string> = {
  ...
  "Your Magic: The Gathering collection, in focus.": "Tu colección de cartas de Magic: The Gathering, en perspectiva.",
  "Track MTG card prices and market momentum, then make your next move with confidence.": "Sigue los precios de cartas de MTG y el impulso del mercado para decidir con confianza.",
