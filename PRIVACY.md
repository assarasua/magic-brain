...
This repository does not itself operate a service. A person or organization
deploying Magic Brain is the data controller/operator and must replace this
template with its identity, contact details, jurisdiction-specific legal
bases, retention periods, and actual subprocessors before offering a service.
...
Users may have rights to access, correct, export, delete, restrict, or object
to processing and to complain to a regulator. Operators must publish a working
privacy contact and a process for identity verification and requests. Browser
and provider controls may also limit cookies or revoke connected accounts.

## Security and changes

Operators should use TLS, least-privilege access, encrypted secret storage,
backups, logging controls, and an incident response process. No system is
perfectly secure. Material changes to a deployed notice should be dated and
communicated as required by applicable law.
