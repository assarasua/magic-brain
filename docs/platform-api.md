...
single-use codes, 15-minute access tokens, and rotating 30-day refresh tokens.
Tokens and codes are stored only as SHA-256 hashes. Revocation is immediate.
...
3. Apply migrations `021` and `022` through the existing migration runner
